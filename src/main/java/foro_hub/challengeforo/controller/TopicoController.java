package foro_hub.challengeforo.controller;

import foro_hub.challengeforo.domain.curso.Curso;
import foro_hub.challengeforo.domain.curso.CursoRepository;
import foro_hub.challengeforo.domain.respuesta.DetalleRespuestaDTO;
import foro_hub.challengeforo.domain.respuesta.Respuesta;
import foro_hub.challengeforo.domain.respuesta.RespuestaRepository;
import foro_hub.challengeforo.domain.topico.*;
import foro_hub.challengeforo.domain.topico.validaciones.actualizar.ValidarTopicoActualizado;
import foro_hub.challengeforo.domain.topico.validaciones.crear.ValidarTopicoCreado;
import foro_hub.challengeforo.domain.usuario.Usuario;
