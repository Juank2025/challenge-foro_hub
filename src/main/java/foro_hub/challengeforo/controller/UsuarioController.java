...
import foro_hub.challengeforo.domain.usuario.*;
import foro_hub.challengeforo.domain.usuario.validaciones.actualizar.ValidarActualizarUsuario;
import foro_hub.challengeforo.domain.usuario.validaciones.crear.ValidarCrearUsuario;
...
public class UsuarioController {
    ...
    @PutMapping("/{username}")
    @Transactional
    @Operation(summary = "Actualiza la contraseña de un usuario, rol, nombre, correo electrónico o estado habilitado")
